...
namespace SkyCarsWebAPI.Models.Common
{
    ...
    {
        public static ApiResponse GenerateResponse(ApiStatusCode StatusCode, string Message, object Data = null,object FileData =null, string StatusText = "")
        {
            return new ApiResponse() { StatusCode = (int)StatusCode, StatusText = StatusText == "" ? StatusCode.ToString() : StatusText, Message = Message, Data = Data,FileData= FileData };
        }
    }
